...
//        $this->result['subcategory'] = $this->Subcategory_model->get_data();
    ...
    public function index() {
        if (!has_permissions('read', 'guess_the_word')) {
            ...
            $this->result['language_english'] = $this->Language_model->get_english_lang_id();  // get the english us and uk language data
    ...
    public function get_main_category_index(){
        if (!has_permissions('read', 'guess_the_word')) {
            ...
            if (!has_permissions('read', 'categories')) {
                ...
                $this->result['language'] = $this->Language_model->get_english_lang_id();
