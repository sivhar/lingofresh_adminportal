                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form method="post" class="needs-validation" novalidate="">
                                                    ...
                                                    <div class="col-md-6 col-sm-12 adsHide">  
                                                        ...
                                                        <div>
                                                            <div class="form-check-inline bg-light p-2">
                                                                ...
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input" name="ads_type" value="2" required  <?php
                                                ...
                                                <div class="adsfacebook">
                                                    <div class="form-group row">
                                                        <div class="col-md-4 col-sm-12">
                                                            <label class="control-label">Android Banner Id</label>
                                                            <input type="text" id="android_fb_banner_id" name="android_fb_banner_id" class="form-control facebookAtt" value="<?= (!empty($android_fb_banner_id['message'])) ? $android_fb_banner_id['message'] : "" ?>">
                                                        </div>                                                   
                                                        <div class="col-md-4 col-sm-12">
                                                            <label class="control-label">Android Interstitial Id</label>
                                                            <input type="text" id="android_fb_interstitial_id" name="android_fb_interstitial_id" class="form-control facebookAtt" value="<?= (!empty($android_fb_interstitial_id['message'])) ? $android_fb_interstitial_id['message'] : "" ?>">
                                                        </div>
                                                        <div class="col-md-4 col-sm-12">
                                                            <label class="control-label">Android Rewarded Id</label>
                                                            <input type="text" id="android_fb_rewarded_id" name="android_fb_rewarded_id" class="form-control facebookAtt" value="<?= (!empty($android_fb_rewarded_id['message'])) ? $android_fb_rewarded_id['message'] : "" ?>">
                                                        </div>
                                                    </div>                                                    
                                                    <div class="form-group row">
                                                        <div class="col-md-4 col-sm-12">
                                                            <label class="control-label">IOS Banner Id</label>
                                                            <input type="text" id="ios_fb_banner_id" name="ios_fb_banner_id" class="form-control facebookAtt" value="<?= (!empty($ios_fb_banner_id['message'])) ? $ios_fb_banner_id['message'] : "" ?>">
                                                        </div>
                                                        <div class="col-md-4 col-sm-12">
                                                            <label class="control-label">IOS Interstitial Id</label>
                                                            <input type="text" id="ios_fb_interstitial_id" name="ios_fb_interstitial_id" class="form-control facebookAtt" value="<?= (!empty($ios_fb_interstitial_id['message'])) ? $ios_fb_interstitial_id['message'] : "" ?>">
                                                        </div>
                                                        <div class="col-md-4 col-sm-12">
                                                            <label class="control-label">IOS Rewarded Id</label>
                                                            <input type="text" id="ios_fb_rewarded_id" name="ios_fb_rewarded_id" class="form-control facebookAtt" value="<?= (!empty($ios_fb_rewarded_id['message'])) ? $ios_fb_rewarded_id['message'] : "" ?>">
                                                        </div>
                                                    </div> 
                                                </div>
